...
var RegisterModal = (function (Component) {
	function RegisterModal(props, context) {
		_classCallCheck(this, RegisterModal);

		_get(Object.getPrototypeOf(RegisterModal.prototype), "constructor", this).call(this, props, context);
		this.submitProfile = this.submitProfile.bind(this);
		this.register = this.register.bind(this);
	}

	_inherits(RegisterModal, Component);

	_prototypeProperties(RegisterModal, null, {
		submitProfile: {
...
module.exports = connect(stateToProps)(RegisterModal);